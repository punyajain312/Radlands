...
const ZOOM_LEVELS = [0.6, 0.75, 1.0, 1.25, 1.5, 1.75, 2.0]
    ...
    <div className="rb-root">
      ...
      <header className="rb-header">
        ...
        <div className="rb-header-controls">
          <button className="rb-btn rb-btn-zoom" onClick={zoomOut} disabled={zoomIdx === 0} title="Zoom out">−</button>
          <span className="rb-zoom-label">{Math.round(scale * 100)}%</span>
          <button className="rb-btn rb-btn-zoom" onClick={zoomIn} disabled={zoomIdx === ZOOM_LEVELS.length - 1} title="Zoom in">+</button>
      ...
      <div className="rb-stage">
        ...
        {error && (
          <div className="rb-status">
            ...
            <a className="rb-btn rb-btn-dl" href="/rulebook.pdf" download="Radlands_Rulebook.pdf" style={{marginTop: 16}}>↓ DOWNLOAD RULEBOOK</a>
          </div>
        )}
        ...
        <div className={`rb-doc-wrap ${loading ? 'rb-hidden' : ''}`}>
          ...
          <div className="rb-page-frame">
            {/* Scanline overlay on top of the PDF canvas */}
